...
<head>
    ...
    <title>Dacor Tintas Automotivas</title>
...
<body class="bg-white">
                ...
                <div class="container-fluid">
                    <nav class="navbar navbar-expand-lg custom_nav-container ">
                        <a class="navbar-brand" href="index.html">
                            <img src="login/img/logo-painel.png" alt="">
                        </a>
                        </a>
                            ...
                            <div class="row">
                                <div class="col-md-10 mx-auto">
                                    <div class="detail-box">
                                        ...
                                        <div class="btn-box">
                                            <a href="#Contatenos" class="btn1">
                                                Contate-nós
                                            </a>
                                            <a href="#Sobrenos" class="btn2">
                                                Sobre-nós
                                            </a>
                                        </div>
                                    </div>
        ...
        <div class="service_container">
            <div class="container ">
                <div class="heading_container">
                    ...
                    <p>
                        Mensagem para tipos de serviços ou tintas enfim 
                    </p>
                </div>
                <div class="row">
                    <div class="col-md-6 col-lg-3">
                        <div class="box ">
                            ...
                            <div class="detail-box">
                                ...
                                <p>
                                    Muito boa para pintar
                                </p>
                                <a href="">
                                    Saiba mais sobre essa tinta
                                </a>
                            </div>
                        </div>
                    </div>
    ...
    <section class="about_section" id="Sobrenos">
        <div class="container  ">
            <div class="row">
                <div class="col-md-6">
                    <div class="detail-box">
                        ...
                        <p>
                            Aqui vai uma mensagem explicando um pouco sobre a história da empresa e suas qualidades
                        </p>
                    </div>
                </div>
                <div class="col-md-6 ">
    ...
    <section class="project_section layout_padding" id="Clientes">
        <div class="container">
            <div class="heading_container">
                <h2>
                    Resultados
    ...
    <!-- client section -->
    <section class="client_section layout_padding" id="Depoimentos">
        <div class="container">
...
<!--
    ...
    <!-- contact section -->
    <section class="contact_section layout_padding-bottom" id="Contatenos">
        <div class="container-fluid">
