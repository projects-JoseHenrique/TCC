...
<?php 
      ...
      <td align="left">
<img src="<?php echo $url_sistema ?>img/<?php echo $foto ?>" width="13px">
</td>

<td class="esc"><?php echo $res[$i]['descricao'] ?></td>
<td class="esc">R$ <?php echo number_format($res[$i]['valor'], 2, ',', '.'); ?></td>
<td class="esc"><?php echo $nome_usuario ?></td>
<td class="esc"><?php echo implode('/', array_reverse(explode('-', $res[$i]['data']))); ?></td>
    </tr>
