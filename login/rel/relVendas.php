			...
			<small><small>
				<section class="area-tab" style="background-color: #f5f5f5;">
					...
					<div class="linha-cab" style="padding-top: 5px;">
						<div class="coluna" style="width:15%">STATUS</div>
						...
						<div class="coluna" style="width:20%">OPERADOR</div>
						<div class="coluna" style="width:20%">PAGAMENTO</div>
...
<?php 
			...
			for ($i=0; $i < @count($res); $i++) { 
				...
				<section class="area-tab" style="padding-top:5px">					
					<div class="linha-cab">				
						<div class="coluna" style="width:15%"><img src="<?php echo $url_sistema ?>img/<?php echo $foto ?>" width="13px"> <?php echo $status ?></div>
						<div class="coluna" style="width:15%">R$ <?php echo $total ?> </div>
						<div class="coluna" style="width:15%"><?php echo $data ?></div>				
						<div class="coluna" style="width:15%"><?php echo $hora ?></div>
						<div class="coluna" style="width:20%"><?php echo $nome_usu ?></div>
						<div class="coluna" style="width:20%"><?php echo $nome_pgto ?></div>			
