				...
				<tbody>
					...
					for($i=0; $i < $total_reg; $i++){
						...
						<tr class="<?php echo $vencido ?>">
							...
							<td><?php echo $res[$i]['descricao'] ?> <small><span style="color:blue"><?php echo $nome_cli ?></span></small></td>
							...
							<td>
								...
								<a href="#" onclick="parcelar('<?php echo $id ?>')" title="Parcelar Conta" style="text-decoration: none">
									<i class="bi bi-calendar text-success mx-1"></i>
			...
			<form method="POST" id="form">
				<div class="modal-body">
					...
					<div class="mb-3">
						...
						<select class="form-select mt-1 sel3" aria-label="Default select example" name="cliente" style="width:100%">
		...
		<div class="modal-content">
			...
			<form method="POST" id="form-parcelar">
				<div class="modal-body">
					...
					<small><div align="center" class="mt-1" id="mensagem-parcelar">
						
					</div> </small>

				</div>
				<div class="modal-footer">
					<button type="button" id="btn-fechar-parcelar" class="btn btn-secondary" data-bs-dismiss="modal">Fechar</button>
