					...
					for($i=0; $i < $total_reg; $i++){
						...
						<tr>
							...
							<td class="text-center">
								...
								<a href="index.php?pagina=contas_receber_vencidas&funcao=baixar&id=<?php echo $res[$i]['id'] ?>" title="Baixar Registro" style="text-decoration: none">
		...
		$.ajax({
			...
			success: function (mensagem) {
				...
				if (mensagem.trim() == "Baixado com Sucesso!") {
					...
					window.location = "index.php?pagina=contas_receber_vencidas";
