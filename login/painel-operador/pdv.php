      ...
      <form method="POST" id="form-fechar-venda">
        <div class="modal-body">
          ...
          <div class="row">
            ...
            <select class="form-select mt-1 sel2" aria-label="Default select example" name="cliente" id="cliente" style="width:100%">
            ...
            <input type="date" name="data_pg" id="data_pg" class="form-control" value="<?php echo $data_hoje ?>">
          </div>
            </div>
          ...
          <?php 
              ...
              if($total_reg > 0){ 
                ...
                for($i=0; $i < $total_reg; $i++){
                  foreach ($res[$i] as $key => $value){ }
                    ?>
                  <span class=""><small><small><small><?php echo $i + 1 ?> - <?php echo $res[$i]['nome'] ?> / </small></small></small></span>  
                <?php } } ?>

          <div class="mb-3">
            
            <select class="form-select form-select-sm mt-1" aria-label="Default select example" name="forma_pgto" id="forma_pgto" onchange="mudarPgto()">
              <?php 
