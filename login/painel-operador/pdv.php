                ...
                <form method="post" id="form-buscar">
                    <div class="row py-2">
                        <div class="col-md-7">
                            ...
                            <div class="row">
                                <div class="col-6">
                                    ...
                                    <input type="text" class="form-control  form-control-md" id="quantidade"
                        ...
                        <div class="col-md-5">
                            ...
                            <input type="text" class="form-control form-control-md" id="total_item" name="total_item"
                                placeholder="Código de Barras">
                            ...
                            <input type="text" class="form-control  form-control-md" id="desconto" name="desconto"
                                placeholder="Desconto em <?php echo $desc ?>">
                            ...
                            <input type="text" class="form-control  form-control-md" id="valor_troco" name="valor_troco"
