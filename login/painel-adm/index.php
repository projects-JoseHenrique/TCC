          ...
          <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
            ...
            <li><a class="dropdown-item" href="index.php?pagina=<?php echo $menu3 ?>">Fornecedores</a></li>
              ...
              <li><a class="dropdown-item" href="index.php?pagina=<?php echo $menu8 ?>">Formas de Pagamento</a></li>   
                ...
                <li><a class="dropdown-item" href="index.php?pagina=<?php echo $menu12 ?>">Clientes</a></li>          
...
<!--  Modal Rel-->
<div class="modal fade" tabindex="-1" id="ModalRelContasReceber" data-bs-backdrop="static">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title">Relatório de Contas Receber</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
       <form action="../rel/relContasReceber_class.php" method="POST" target="_blank">
                ...
                <div class="modal-body">
                 ...
                 <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group mb-3">
                            <label >Cliente</label>
                            <select class="form-select mt-1 sel2"  name="cliente" style="width:100%">
...
<script type="text/javascript">
  $(document).ready(function() {
    $('.sel2').select2({
      dropdownParent: $('#ModalRelContasReceber')
    });
  });
</script>
