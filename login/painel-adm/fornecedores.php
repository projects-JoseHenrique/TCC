...
<style>
  ...
  #example th,
  #example td {
    border-left: 1px solid #ccc; /* Adiciona uma borda esquerda às células */
    border-right: 1px solid #ccc; /* Adiciona uma borda direita às células */
    padding: 8px; /* Adicione um espaçamento interno para melhor aparência */
...
<a href="index.php?pagina=<?php echo $pag ?>&funcao=novo" type="button" class="btn btn-success mt-2" style="margin-left:10px;">Novo Fornecedor</a>
			...
			<table id="example" class="table table-hover my-4" style="width:100%;  margin-left:10px;">
				<thead>
					<tr class="bg-success">
						...
						<th class="text-white text-center">Tipo Pessoa</th>
						<th class="text-white text-center">CPF / CNPJ</th>
				...
				<tbody>
					...
					for($i=0; $i < $total_reg; $i++){
						...
						<tr>
							...
							<td class="text-center"><b><?php echo $res[$i]['tipo_pessoa'] ?></b></td>
							...
							<td class="text-center">
								...
								<a href="#" onclick="mostrarDados('<?php echo $res[$i]['endereco'] ?>', '<?php echo $res[$i]['nome'] ?>')" title="Ver Endereço">
									<i class="bi bi-geo-alt-fill text-warning"></i></i>
								</a>
			...
			<form method="POST" id="form">
				<div class="modal-body">
					...
					<div class="mb-3">
						...
						<input type="text" class="form-control" id="endereco" name="endereco" placeholder="Rua X Número X Bairro X ..."  value="<?php echo @$endereco ?>">
					</div>  
